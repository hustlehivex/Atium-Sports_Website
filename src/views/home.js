...
const Home = (props) => {
 ...
 document.addEventListener("DOMContentLoaded", () => {
      ...
      const observer = new IntersectionObserver(
        ...
        { threshold: 0.3 } // trigger when 30% of text is visible
      );
  ...
  <div className="home-hero-content floating-text">
...
Empowering Sports organisations and their athletes to reach their peak performance through digitization, Sports Science & Artificial Intelligence.
    ...
    <button className="button home-button1">
      ...
      {/* <AnimateOnScroll tag="h1" duration={1.5}>
  Slow Animation (1.5s)
</AnimateOnScroll>

<AnimateOnScroll tag="p" duration={0.5}>
  Fast Animation (0.5s)
</AnimateOnScroll> */}
